...
bool CST9217_Read_Data(void) {
  ...
  if (CST9217.points > CST9217_MAX_TOUCH_POINTS)
    CST9217.points = CST9217_MAX_TOUCH_POINTS;
  for (uint8_t i = 0; i < CST9217_MAX_TOUCH_POINTS; ++i)
    CST9217.data[i].valid = false;
