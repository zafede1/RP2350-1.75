// ---------------------------------------------------------------- //
// This file is autogenerated by pioasm; derived from Waveshare's
// RP2350-Touch-AMOLED-1.75 Arduino example.
// ---------------------------------------------------------------- //
#pragma once
#if !PICO_NO_HARDWARE
...
static const uint16_t qspi_4wire_data_program_instructions[] = { 0x7004, 0xb842 };
#if !PICO_NO_HARDWARE
...
static const uint16_t qspi_1write_cmd_program_instructions[] = { 0x7001, 0xb842 };
#if !PICO_NO_HARDWARE
...
static inline void qspi_4wire_data_program_init(PIO pio, uint sm, uint offset, uint pin_scl, uint out_base, uint out_pin_num) {
    ...
    for (uint32_t pin_offset = 0; pin_offset < out_pin_num; pin_offset++) pio_gpio_init(pio, out_base + pin_offset);
